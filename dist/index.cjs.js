...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/niccoming/pancake-uikit/blob/master/src/widgets/Menu/logo.svg?raw=true", alt: "Milkswap Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/niccoming/pancake-uikit/blob/master/src/widgets/Menu/cashcowdefi_logo.svg?raw=true", alt: "Milkswap Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/niccoming/pancake-uikit/blob/master/src/widgets/Menu/logo.svg?raw=true", alt: "Milkswap Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/niccoming/pancake-uikit/blob/master/src/widgets/Menu/cashcowdefi_logo.svg?raw=true", alt: "Milkswap Logo", className: "desktop-icon" })))));
};
